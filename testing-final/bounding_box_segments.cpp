...
void finding_motif(vector<pair<double, double> > &points, int k, int percentage_change = 250 ){
...
int main(int argc, char* argv[])
{
    ...
    // cout << find_dfd(0, 10, 11, 20, points) << " :the resulting dfd";
    

    int motif_length, percentage_change;

    int slicing_start = 0, slicing_end = 0;
    cout << "Start slicing at: ";
    cin >> slicing_start;
    cout << "End slicing at: ";
    cin >> slicing_end;

    vector<pair<double, double> > testing_set = slice(points, slicing_start, slicing_end);

    while(true){
        cout << "Enter Motif Length: ";
        cin >> motif_length;
        cout << "Enter percentage: ";
        cin >> percentage_change;
        finding_motif(testing_set, motif_length, percentage_change);
